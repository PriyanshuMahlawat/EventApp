document.addEventListener("DOMContentLoaded", async function () {
    ...
    async function getFinalTable() {
        ...
        try {
            const response = await fetch(`https://amithehost.onrender.com/api/realTable/${username}/${event_id}/`);
            if (!response.ok) {
    ...
    function updateCurrentTable() {
        return fetch(`https://amithehost.onrender.com/api/currenttable/${event_id}/`, {
            method: "POST",
            headers: {
    ...
    function fetchEventRooms() {
        fetch(`https://amithehost.onrender.com/api/${event_id}/`)
            .then(response => response.json())
            .then(data => {
    ...
    async function prepareAndSendData() {
        try {
            ...
            const response = await fetch(`https://amithehost.onrender.com/api/excelSheets/${event_id}/`, {
                method: "POST",
                headers: {
                    'Content-Type': 'application/json',
                    'X-CSRFToken': csrftoken,
