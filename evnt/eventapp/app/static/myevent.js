document.addEventListener("DOMContentLoaded", function() {
    ...
    fetch("https://amithehost.onrender.com/api/host/")
    ...
    function addToHost(data) {
            ...
            for (let i = 0; i < data.length; i++) {
                ...
                deletehost = `https://amithehost.onrender.com/api/hostdel/${arr[i].id}/`; 
                managelink.href = "https://amithehost.onrender.com/manageEvent/";
                ...
                manageBtn.addEventListener("click", function(event) {
                    ...
                    .then(data => {
                        ...
                        window.location.href = "https://amithehost.onrender.com/manageEvent/";
                    })
                    .catch(error => {
                        console.error("Error:", error);
                    });
    ...
    fetch("https://amithehost.onrender.com/api/joined/")
    .then(response => response.json())
    .then(data => {
        console.log(data);
    ...
    function addToJoined(data) {
        console.log(data.length)
            ...
            for (let i = 0; i < data.length; i++) {
                ...
                paraEl.textContent = arr[i].Event_name;
                deleteevent = `https://amithehost.onrender.com/api/leaveevent/${arr[i].id}/`;
